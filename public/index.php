...
$router->map(
    ...
    '/category/update/[i:id]',
    [
        'method' => 'categoryUpdatePost',
        'controller' => '\App\Controllers\CategoryController'
    ],
    'catalog-categoryUpdatePost'
);
...
$router->map(
    ...
    '/product/update/[i:id]',
    [
        'method' => 'productUpdatePost',
        'controller' => '\App\Controllers\ProductController'
    ],
    'catalog-productUpdatePost'
);
